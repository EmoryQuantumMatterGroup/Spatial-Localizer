...
## HDF5 
Besides Python and the provided conda environment, we note that we use the HDF5 (https://www.hdfgroup.org/download-hdf5/) file system software to store/access data, such as dictionaries or Numpy arrays. 
This is accessed via the h5py Python package, but HDF5 often must be separately installed on the machine. We use HDF5 version 1.14.5.
